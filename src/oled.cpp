...
//       // 有新数据时更新显示缓存
//       // if (oled_display_flag) {
//       int throttle = map(displayData.joystick_cur_val[0], ADC_OUT_MIN, ADC_OUT_MAX, ADC_MIN, 255);
//       int aileron  = map(displayData.joystick_cur_val[2], ADC_OUT_MIN, ADC_OUT_MAX, ADC_MIN, SERVO_MAX_ANGLE);
//       int elevator = map(displayData.joystick_cur_val[3], ADC_OUT_MIN, ADC_OUT_MAX, ADC_MIN, (SERVO_MAX_ANGLE - 20));
//       //   switch (page) {
//       //   case 0:
//       // 设备状态
//       u8g2.clearBuffer();
